    ...
    <div class="table-responsive text-nowrap">
      ...
      <table class="table table-bordered" style="margin-bottom: 20px;" id="locationTable">
        ...
        <tr>
            ...
            <td style="color: {{ $exp->status == 'active' ? 'green' : 'red' }};">{{ $exp->status }}</td>

            <td>{{ $exp->created_at }}</td>
            <td><a href="javascript:void(0);" data-id="{{ $exp->id }}" class="btn-delete" title="Inactive"><i class="bx bx-trash me-1" style=" color:red;"></i></a>
            <a href="{{ route('new_expences.update', $exp->id) }}" title="Edit">
